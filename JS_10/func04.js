//화살표 함수
//ESS(ECMASCRIPT 2015) 에서 시작된 새로운 개념의 함수
//function 키워드가 사라졌다
// () 로 시작되는 함수 명령문
// () 다음에 => 연산자가 나타난다
const func1 = () => {
  console.log("나는 화살표(Arrow)함수입니다");
};
func1();
...
// 두개의 매개변수를받는 func3 함수 선언
// 두개의 매새변수 값을 덧셈하여 return
const func3 = (num1, num2) => {
  return num1 + num2;
};
// 두개의 매개변수를 받아서 덧셈하여 return 하는 func4 함수
// 함수 본체에 다른 코드 없이 오로지 return 명령문 만 있을경우
//{} return 키워드를 생략 가능
